...
for name, model in models:
    cv_results = cross_val_score(
        model, X_res, y_res, cv=kf, scoring=scoring)
...
plt.savefig(("D:\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\_averaged_CM_full_wn.png"), dpi = 500, bbox_inches="tight")

#%%
# Summarising precision, f_score, and recall for the training set
cr_full_wn = classification_report(save_true, save_predicted)
print('Classification report : {}'.format(cr_full_wn))

# save classification report to disk as a csv

cr_full_wn = pd.read_fwf(io.StringIO(cr_full_wn), header=0)
cr_full_wn = cr_full_wn.iloc[1:]
cr_full_wn.to_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\classification_report_full_wn.csv")

#%%
# Results
kf_results.to_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\crf_kfCV_record.csv", index=False)
kf_results = pd.read_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\crf_kfCV_record.csv")

# Accuracy distribution
crf_acc_distrib = kf_results["Accuracy"]
crf_acc_distrib.columns=["Accuracy"]
crf_acc_distrib.to_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\crf_acc_distrib.csv", header=True, index=False)
crf_acc_distrib = pd.read_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\crf_acc_distrib.csv")
...
crf_per_class_acc_distrib.dropna().to_csv("D:\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\crf_per_class_acc_distrib.csv")
crf_per_class_acc_distrib = pd.read_csv("D:\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\crf_per_class_acc_distrib.csv", index_col=0)
...
crf_per_class_acc_distrib_describe.to_csv("D:\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\crf_per_class_acc_distrib.csv")
...
plt.savefig(("D:\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\per_class_acc_distrib_full_wn.png"), dpi = 500, bbox_inches="tight")
...
rskf_results = pd.read_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\crf_kfCV_record.csv")
...
fig = all_featimp["mean"][-20:].plot(figsize=(4, 8),
                                    kind="barh",
                                    legend=False,
...
# plt.savefig(("D:\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\_feature_impces_full_wn.png"), dpi = 500, bbox_inches="tight")
...
plt.savefig(("D:\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\_average_CM_pca.png"), dpi = 500, bbox_inches="tight")
...
cr_pca.to_csv("D:\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\classification_report_pca.csv")


#%%
# Results
kf_results.to_csv("D:\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\crf_kfCV_record_pca.csv", index=False)
kf_results = pd.read_csv("D:\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\crf_kfCV_record_pca.csv")

# Accuracy distribution
crf_acc_distrib = kf_results["Accuracy"]
crf_acc_distrib.columns=["Accuracy"]
crf_acc_distrib.to_csv("D:\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\crf_acc_distrib_pca.csv", header=True, index=False)
crf_acc_distrib = pd.read_csv("D:\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\crf_acc_distrib_pca.csv")
crf_acc_distrib = np.round(crf_acc_distrib, 2)
print(crf_acc_distrib)
...
class_names = np.unique(np.sort(y))
crf_per_class_acc_distrib = pd.DataFrame(kf_per_class_results, columns=class_names)
crf_per_class_acc_distrib.dropna().to_csv("D:\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\crf_per_class_acc_distrib_pca.csv")
crf_per_class_acc_distrib = pd.read_csv("D:\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\crf_per_class_acc_distrib_pca.csv", index_col=0)
crf_per_class_acc_distrib = np.round(crf_per_class_acc_distrib, 2)
crf_per_class_acc_distrib_describe = crf_per_class_acc_distrib.describe()
crf_per_class_acc_distrib_describe.to_csv("D:\Projects\Sporozoite Spectra for An funestus s.s\ML analysis\crf_per_class_acc_distrib_pca.csv")
