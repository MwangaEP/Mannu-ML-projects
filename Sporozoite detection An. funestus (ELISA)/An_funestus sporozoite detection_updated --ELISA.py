...
plt.savefig(("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Results\ELISA model\Algorithm selection_elisa.png"), dpi = 500, bbox_inches="tight")
...
with open('C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Results\ELISA model\classifier.pkl', 'wb') as fid:
...
plt.savefig(("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Results\ELISA model\_averaged_CM_full_wn_elisa.png"), dpi = 500, bbox_inches="tight")

#%%
# Results
kf_results.to_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Results\ELISA model\crf_kfCV_record.csv", index=False)
kf_results = pd.read_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Results\ELISA model\crf_kfCV_record.csv")

# Accuracy distribution
crf_acc_distrib = kf_results["Accuracy"]
crf_acc_distrib.columns=["Accuracy"]
crf_acc_distrib.to_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Results\ELISA model\crf_acc_distrib.csv", header=True, index=False)
crf_acc_distrib = pd.read_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Results\ELISA model\crf_acc_distrib.csv")
...
crf_per_class_acc_distrib.dropna().to_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Results\ELISA model\crf_per_class_acc_distrib.csv")
crf_per_class_acc_distrib = pd.read_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Results\ELISA model\crf_per_class_acc_distrib.csv", index_col=0)
...
crf_per_class_acc_distrib_describe.to_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Results\ELISA model\crf_per_class_acc_distrib.csv")
...
plt.savefig(("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Results\ELISA model\per_class_acc_distrib_full_wn.png"), dpi = 500, bbox_inches="tight")
...
rskf_results = pd.read_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Results\ELISA model\crf_kfCV_record.csv")
...
plt.savefig(("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Results\ELISA model\_feature_impces_full_wn.png"), dpi = 500, bbox_inches="tight")
...
plt.savefig(("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Results\ELISA model\CM_full_wn_val_elisa.png"), dpi = 500, bbox_inches="tight")
...
cr_full_wn_val.to_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Results\ELISA model\classification_report_full_wn_val_elisa.csv")
...
with open('C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Results\ELISA model\important_wavenumbers.txt', 'w') as outfile:
...
# load age data
df_age = pd.read_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Data\wild_funestus_age.dat", delimiter = '\t')
...
plt.savefig(("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Results\ELISA model\CM_age_sporozoite_elisa.png"), dpi = 500, bbox_inches="tight")
...
cr_full_wn_val_age.to_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Results\ELISA model\classification_report_full_wn_val_age.csv")
...
full_bio_attr_df = pd.read_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Data\Biological_attr.dat", delimiter= '\t')
...
plt.savefig(("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Results\ELISA model\CM_full_wn_val_pcr.png"), dpi = 500, bbox_inches="tight")
...
cr_full_wn_val_pcr.to_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\ML_final_analysis\Results\ELISA model\classification_report_full_wn_val_pcr.csv")
