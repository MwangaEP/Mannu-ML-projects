...
def plot_confusion_matrix(cm, classes,
    ...
    plt.savefig(("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\Phd data\Results\Confusion_Matrix_" + figure_name + "_" + ".png"), dpi = 500, bbox_inches="tight")
...
# plt.savefig(("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\Phd data\Results\_algo_selection_.png"), dpi = 500, bbox_inches="tight")
...
with open('C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\Phd data\Results\classifier.pkl', 'wb') as fid:
     pickle.dump(best_classifier, fid)

# %%

# Results
kf_results.to_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\Phd data\Results\crf_kfCV_record.csv", index=False)
kf_results = pd.read_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\Phd data\Results\crf_kfCV_record.csv")

# Accuracy distribution
crf_acc_distrib = kf_results["Accuracy"]
crf_acc_distrib.columns=["Accuracy"]
crf_acc_distrib.to_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\Phd data\Results\crf_acc_distrib.csv", header=True, index=False)
crf_acc_distrib = pd.read_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\Phd data\Results\crf_acc_distrib.csv")
...
crf_per_class_acc_distrib.dropna().to_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\Phd data\Results\crf_per_class_acc_distrib.csv")
crf_per_class_acc_distrib = pd.read_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\Phd data\Results\crf_per_class_acc_distrib.csv", index_col=0)
...
crf_per_class_acc_distrib_describe.to_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\Phd data\Results\crf_per_class_acc_distrib.csv")
...
plt.savefig(("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\Phd data\Results\per_class_acc_distrib_full_wn.png"), dpi = 500, bbox_inches="tight")
...
visualize(figure_name, classes, y_test,y_val_pred)
...
cr_full_wn_val.to_csv("C:\Mannu\Projects\Sporozoite Spectra for An funestus s.s\Phd data\Results\classification_report_full_wn_val.csv")
