...
def plot_confusion_matrix(cm, classes,
    ...
    plt.savefig(
                    (
                        r"C:\Mannu\Projects\Mwanga-DBS work\Parasite age\ML analysis\RBC_ageing\Confusion_Matrix_" 
                        + figure_name 
                        + "_" 
                        + ".png"
                    ), 
...
base_directory = r"C:\Mannu\Projects\Mwanga-DBS work\Parasite age\ML analysis\RBC_ageing"
